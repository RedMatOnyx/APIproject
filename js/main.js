...
// const imageBaseUrl = "https://loremflickr.com/320/240"
// var imageSuffix = "/" + giveArea();
var someplace = giveArea();
console.log(someplace);
// document.getElementById('locationImage').setAttribute("src", "imageBaseUrl + imageSuffix");
document.getElementById('locationImage').setAttribute("src", "https://loremflickr.com/320/240/denver");
